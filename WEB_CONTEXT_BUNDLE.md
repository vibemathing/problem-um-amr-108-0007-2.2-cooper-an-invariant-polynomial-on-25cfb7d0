...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-108-0007"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-v1",
      "problem_contract_sha256": "01d9dd247bf446dfcec5eb60338f2c836337e68ba0f920a18424948612aef867",
      "problem_id": "problem:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0",
      "route_id": "route:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-source-fidelity-01",
      "graph_id": "graph:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a nonzero polynomial on $U\\otimes V\\otimes W$ invariant under $SL(U)\\times SL(V)\\times SL(W)$ when $\\dim U=\\dim V=4$ and $\\dim W=8$?"
          },
          "statement_sha256": "c2f2736e088bb1fe8c629f6842548e13bb0f95965451c9b04e821db7fc7c68c7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-root",
      "route_id": "route:um-amr-108-0007-2.2-cooper-an-invariant-polynomial-on-25cfb7d0-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-108-0007-4bf36bc46a7e",
        "url": "https://www.unsolvedmath.com/problems/AMR-108-0007"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
